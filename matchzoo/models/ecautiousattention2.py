...
class ECautiousAttention2(BasicModel):
    def __init__(self, config):
        super(ECautiousAttention2, self).__init__(config)
        self.__name = 'ECautiousAttention2'
        ...
        self.setup(config)
        if not self.check():
            raise TypeError('[ECautiousAttention2] parameter check wrong')
        print('[ECautiousAttention2] init done', end='\n')
