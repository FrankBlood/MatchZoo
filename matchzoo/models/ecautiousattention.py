...
class ECautiousAttention(BasicModel):
    def __init__(self, config):
        super(ECautiousAttention, self).__init__(config)
        self.__name = 'ECautiousAttention'
        ...
        self.setup(config)
        if not self.check():
            raise TypeError('[ECautiousAttention] parameter check wrong')
        print('[ECautiousAttention] init done', end='\n')
