...
from tk.networks import Networks
...
def train(data_loader, network):
    ...
    for i in range(2):
        ...
        model.fit_generator(data_loader.tk_data_generator(data_loader.train_path, word_index=word_index, kb=kb, batch_size=batch_size, sample_size=sample_size),
                            steps_per_epoch=data_loader.train_size/batch_size+1,
                            # steps_per_epoch=20,
                            validation_data=data_loader.tk_data_generator(data_loader.val_path, word_index=word_index, kb=kb, batch_size=batch_size, sample_size=sample_size),
        ...
        loss, acc = model.evaluate_generator(data_loader.tk_data_generator(data_loader.test_path,
