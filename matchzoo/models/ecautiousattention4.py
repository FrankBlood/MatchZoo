...
class ECautiousAttention4(BasicModel):
    def __init__(self, config):
        super(ECautiousAttention4, self).__init__(config)
        self.__name = 'ECautiousAttention4'
        ...
        self.setup(config)
        if not self.check():
            raise TypeError('[ECautiousAttention4] parameter check wrong')
        print('[ECautiousAttention4] init done', end='\n')
