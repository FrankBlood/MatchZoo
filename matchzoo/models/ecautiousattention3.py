...
class ECautiousAttention3(BasicModel):
    def __init__(self, config):
        super(ECautiousAttention3, self).__init__(config)
        self.__name = 'ECautiousAttention3'
        ...
        self.setup(config)
        if not self.check():
            raise TypeError('[ECautiousAttention3] parameter check wrong')
        print('[ECautiousAttention3] init done', end='\n')
    ...
    def build(self):
        ...
        attention = concatenate([q_global_pool, d_global_pool])
