...
class ECautiousAttentionAll(BasicModel):
    def __init__(self, config):
        super(ECautiousAttentionAll, self).__init__(config)
        self.__name = 'ECautiousAttentionAll'
        ...
        self.setup(config)
        if not self.check():
            raise TypeError('[ECautiousAttentionAll] parameter check wrong')
        print('[ECautiousAttentionAll] init done', end='\n')
    ...
    def build(self):
        ...
        attention = concatenate([q_rep_last_state, d_rep_last_state, q_global_pool, d_global_pool])
        ...
        merged = concatenate([new_q_rep, new_d_rep, q_global_pool, d_global_pool, q_rep_last_state, d_rep_last_state])
